...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden flex flex-col lg:flex-row">

      {/* LEFT SECTION */}
      <div className="lg:w-1/2 flex flex-col justify-center px-6 md:px-12 py-16">
        <motion.div
        ...
        >
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight tracking-tighter">
            Bridging the <br />
            <span className="text-indigo-500">Impact Gap.</span>
          </h1>

          <p className="mt-6 text-slate-400 text-lg max-w-md">
            A data-driven ecosystem transforming scattered community needs
            into organized social action.
          </p>
        </motion.div>
      </div>

      {/* RIGHT SECTION */}
      <div className="lg:w-1/2 bg-slate-900 flex flex-col justify-center px-6 md:px-12 py-16 space-y-6">
            ...
            <div className="flex items-center space-x-5">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Manage needs and field reports
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-5">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Discover and apply for missions
                </p>
              </div>
            </div>
