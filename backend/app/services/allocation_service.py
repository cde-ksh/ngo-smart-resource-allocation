...
def calculate_volunteer_score(
    ...
    urgency_multiplier = URGENCY_WEIGHT.get(
        request.urgency,
        1
    )
...
def allocate_volunteers_to_request(
    request_id: int,
    db: Session
):
    # ---------------------------------
    ...
    required = (
        request.volunteers_required or 1
    )
    ...
    for volunteer in available_volunteers:
        ...
        result = calculate_volunteer_score(
            volunteer,
            request,
            req_skills
        )
